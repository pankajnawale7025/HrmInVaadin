...
//        layout.setSpacing(false);
        ...
        layout.add(getLoginForm(), getSideImage());
        add(layout);
    }
...
//        parent.add(child);
//
//        parent.getStyle().set("width", "500px").set("height", "400px").setPadding("25px").set("border","1px solid black").set("margin","auto").set("displ","flex").set("justify-content","center");
//        return parent;
//    }
    ...
    public Component getLoginForm() {
        ...
        verticalLayout.add(username, password, button);
        parentDiv.add(verticalLayout);
        parentDiv.getStyle().set("width", "500px");
        return parentDiv;
    }

    public Component getSideImage() {
        VerticalLayout verticalLayout = new VerticalLayout();
